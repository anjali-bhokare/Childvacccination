...
using System.Data;
public partial class User_HospitalLogin : System.Web.UI.Page
{
    ...
    {
        cn.Open();
        cmd.CommandText = "SELECT username FROM HospitalRegistration WHERE username = '" + txtusername.Text + "' AND hospitalpassword = '" + txtpassword.Text + "'";
        cmd.Connection = cn;
        cmd.ExecuteNonQuery();
