<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AppointmentDetails.aspx.cs" Inherits="Report_AppointmentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Report\AppointmentDetails.rpt">
        </Report>
